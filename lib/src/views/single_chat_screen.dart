...
class SingleChatScreen extends GetView<SingleChatController> {
  ...
  //   for (MessageModel msg in controller.chat) {
  //     list.add(_buildMessageBuble(msg));
  //     list.add(FxSpacing.height(16));
  //   }
  //   return list;
  // }

  // Widget _buildMessageBuble(MessageModel messageText) {

  //   // return messageText.senderId != authData.read("user_id")
  //   //     ?
  //   //     :
  // }
...
//convert message time in now, yesterday and show date if it is not today
