...
class Subcategory {
  ...
  factory Subcategory.fromMap(Map<String, dynamic> json) => Subcategory(
        ...
        category: CategoryFavorite.fromMap(json["category"]),
      );
...
class CategoryFavorite {
  ...
  factory CategoryFavorite.fromMap(Map<String, dynamic> json) =>
      CategoryFavorite(
        id: json["id"],
        name: json["name"],
...
class District {
  ...
  factory District.fromMap(Map<String, dynamic> json) => District(
        ...
        createdAt: json["created_at"],
        updatedAt: json["updated_at"],
        region: CategoryFavorite.fromMap(json["region"]),
      );
